...
namespace MHSJ.Web
{
    ...
    public class PageBase : Page
    {
        ...
        public PageBase()
        {
            ...
            //querycount = Loachs.Data.Access.OleDbHelper.QueryCount;
            //Loachs.Data.Access.OleDbHelper.QueryCount = 0;
        }
        ...
        {
            string str =
                "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"><html xmlns=\"http://www.w3.org/1999/xhtml\"><header><title>{0} - {1}</title><style>a {{ color:gray;}}</style></header><body><div  style=\"border:1px solid #94a2a3; background-color:#F1F8FE; width:500px;   padding:8px 25px; margin:100px auto 0 auto;\" ><h5>提示:</h5><h2>{2}</h2><h4><a href=\"{3}\">返回首页</a></h4></div></body></html>";
