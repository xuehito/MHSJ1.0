...
namespace MHSJ.Web.common.tools
{
    public partial class CommonToolsVerifyimage : Page
    {
        private static readonly byte[] randb = new byte[4];
        private static readonly RNGCryptoServiceProvider rand = new RNGCryptoServiceProvider();
        private readonly Bitmap charbmp = new Bitmap(30, 30);
        ...
        private void CreateCheckCodeImage(string checkCode)
        {
            ...
            var image = new Bitmap((int) Math.Ceiling((checkCode.Length*22.5)), 30);
            ...
            try
            {
                ...
                for (int i = 0; i < checkCode.Length; i++)
                {
                    ...
                    var drawPoint = new PointF(charx, 0.1F);
