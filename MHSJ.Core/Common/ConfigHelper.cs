    ...
    public class ConfigHelper
    {
        ...
        public static string SitePrefix
        {
            get
            {
                ...
                {
                    _siteprefix = GetValue("mhsj_siteprefix");
                }
                return _siteprefix;
            }
        }
        ...
        public static string SitePath
        {
            get
            {
                ...
                {
                    _sitepath = GetValue("mhsj_sitepath");
        ...
        public static string SiteUrl
        {
            get
            {
                string _siteurl = "http://" + HttpContext.Current.Request.Url.Host + SitePath;
                if (HttpContext.Current.Request.Url.Port != 80)
                {
                    _siteurl = "http://" + HttpContext.Current.Request.Url.Host + ":" +
        ...
        public static string DbConnection
        {
            get
            {
                ...
                {
                    _dbconnection = GetValue("mhsj_dbconnection");
                }
